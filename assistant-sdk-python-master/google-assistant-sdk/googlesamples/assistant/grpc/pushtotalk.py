        ...
        for resp in self.assistant.Assist(iter_log_assist_requests(),
            ...
            if len(resp.audio_out.audio_data) > 0:
                ...
                if not self.conversation_stream.playing:
                    ...
                    matches = ["reachy", "richie", "reach", "ritchie", "re", "read", "rich", 'rici', 'robot', 'robots']
                    text = "\"" + text + "\""
                    if (text != ""):
                        ...
                        if(followUp == True):
                            ...
                            if (results["verbs"]):
                                semantic_labeling = results["verbs"][0]["description"]
                                print(semantic_labeling)
                                subject = self.find_between(semantic_labeling, "[ARG0: ", "]")
                                verb =  self.find_between(semantic_labeling, "[V: ", "]")
                                part = self.find_between(semantic_labeling, "[ARG1: ", "]")
                                print(part)
